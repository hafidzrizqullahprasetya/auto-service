  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm no-print-overlay">
      <div className="relative w-full max-w-2xl max-h-[90vh] overflow-hidden rounded-2xl bg-white shadow-2xl dark:bg-gray-dark border border-stroke dark:border-dark-3 flex flex-col translate-y-0 opacity-100 transition-all">
        ...
        <div className="flex items-center justify-between border-b border-stroke p-5 dark:border-dark-3 bg-gray-50 dark:bg-dark-2 no-print">
        ...
        {/* Invoice Body */}
        <div id="invoice-content" className="flex-1 overflow-y-auto p-8 space-y-8 bg-white text-black print:p-0">
          {/* Brand Header */}
          <div className="flex flex-col sm:flex-row justify-between items-start gap-4 border-b-2 border-dark pb-6">
            ...
            <div className="text-right sm:items-end flex flex-col">
              ...
              <p className="text-sm font-bold">{transaction.invoiceNo}</p>
          ...
          <div className="grid grid-cols-2 gap-4 bg-gray-50 p-4 rounded-xl border border-gray-100">
            <div>
              ...
              <h4 className="text-base font-black uppercase">{transaction.customerName}</h4>
          ...
          <table className="w-full">
            <thead className="border-b border-dark">
              <tr className="[&>th]:py-3 [&>th]:text-left [&>th]:text-xs [&>th]:font-black [&>th]:uppercase [&>th]:tracking-wider">
            ...
            <tbody className="divide-y divide-gray-100">
              {transaction.items.map((item, idx) => (
                <tr key={idx} className="[&>td]:py-4 [&>td]:text-sm">
        ...
        {/* Footer Actions - Not for print */}
        <div className="border-t border-stroke p-5 dark:border-dark-3 bg-gray-50 dark:bg-dark-2 flex flex-col sm:flex-row gap-3 no-print">
          <button className="flex-1 flex items-center justify-center gap-2 rounded-md border border-stroke bg-white px-5 py-2.5 text-sm font-bold text-dark hover:bg-gray-2 dark:border-dark-3 dark:bg-dark-2 dark:text-white transition-all active:scale-95">

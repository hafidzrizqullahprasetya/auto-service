    ...
    <>
      <div className={cn("flex w-full flex-wrap items-center gap-2 sm:w-auto", className)}>
        ...
        <button
          ...
          className="flex h-9 flex-1 items-center justify-center gap-1.5 rounded-lg border border-stroke bg-white px-3 text-xs font-bold text-dark-5 transition-colors hover:border-primary hover:text-primary dark:border-dark-3 dark:bg-dark-2 dark:text-dark-6 dark:hover:border-primary dark:hover:text-primary sm:flex-none"
        >
          <FileDown size={14} />
